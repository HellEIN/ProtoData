...
from gui.main_page_folder.main_page_variable_state import selected_file, df, file_name, error_message, file_info, dtypes_df, numeric_describe, categorical_describe
...
with tgb.Page() as main_page:
    ...
    with tgb.part(class_name="container card"):
        ...
        tgb.text("*Advice :* For large files, consider converting them to **Parquet** or **Feather** for faster loading and smaller size.",mode="md",class_name="advice _note",)
