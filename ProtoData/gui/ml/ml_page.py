...
from gui.main_page_folder.main_page import (df,available_columns,target_variable,feature_variables,selected_algorithm,algorithms,model_results,ml_error_message,confusion_matrix_fig)
from gui.css import page_style
